 ...
 * Run: node test-register-fix-windows.js
 * 
 * This version works when service is running on Windows
 */

const http = require('http');

// Try Windows host IP first, fallback to localhost
...
async function runTests() {
  ...
  try {
    ...
    console.log(`   Make sure the service is running on ${BASE_URL}`);
    failed++;
  }
  console.log('');
